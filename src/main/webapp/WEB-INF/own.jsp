...
<head>
    ...
    <script>
            ...
            $.ajax({
                ...
                success: function (result) {
                    ...
                    if (data != null) {
                        ...
                        var cloums = ["id", "number", "name", "className", "selfDate", "scoreBySelf", "isPass", "operation"];
            ...
            $.ajax({
                ...
                success: function (result) {
                    ...
                    if (data != null) {
                        ...
                        $('#scoreBySelfUpdate').val("" + scoreBySelf + "");
                    } else {
                        alert(result.msg);
                    }
                },
        ...
        function saveStudentUpdate() {
            ...
            var scoreBySelf = $('#scoreBySelfUpdate').val().trim();
            //发送Ajax请求
            $.ajax({
                type: "post",
                url: "ownStudentUpdate.action",
                data: {
                    "sid": sid,
                    "scoreBySelf": scoreBySelf
                },
            ...
            <div class="modal-content">
                <div class="modal-header">
                    ...
                    <h3 class="modal-title">
                        学生自评<span style="color: red;font-size: 14px">(※ 为必填项)</span>
                    </h3>
                </div>
                <div class="modal-body">
                    <div>
                        <form id="studentUpdateForm" enctype="multipart/form-data">
                            ...
                            <p>
                                <label> <span style="color: red">※</span>自评分数:</label>
                                <input id="scoreBySelfUpdate" name="scoreBySelf" type="text" value="">
                            </p>
