                ...
                success: function (result) {
                    ...
                    if (data != null) {
                        ...
                        for (var i = 0; i < data.length; i++) {
                            var id = data[i].id;
                            var addScore = "<a style='width: 30px' data-toggle='modal' data-target='#studentUpdateModal' onclick=toStudentScoreUpdate('" + id + "');>查看</a>";
                        ...
                        var cloums = ["id", "number", "name", "className", "addScore", "scoreBySelf", "isPass"];
                    ...
                    if (data != null) {
                        if (data.className == "班级不存在") {
                            ...
                            for (var i = 0; i < score.length; i++) {
                                ...
                                str += "<span>" + courseName + ":&nbsp;&nbsp;" + score[i].score + "</span><br>";
                            }
...
<div class="container-fluid">
    ...
    <div id="middlebar">
        <div class="well span3" style="margin:50px 0;padding:0 20px 20px 20px;height: 80%;width: 1323px">
            <h3 style="color:green;">测评结果查询</h3>
            <HR class="xline">
            &nbsp;&nbsp;&nbsp;&nbsp;学生名称:&nbsp;<input id="name" name="name" type="text" style="width:200px"/>&nbsp;&nbsp;
            <input id="search" type="button" value="成绩搜索" name="search"/>&nbsp;&nbsp;
